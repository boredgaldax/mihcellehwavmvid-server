...
namespace Mihcelle.Hwavmvid.Modules.ChatHubs.Repository
{
    public class ChatHubRepository
    {
        ...
        {
            ChatHubUser item = await this._db.ChatHubUser.FirstAsync(u => u.Id == id);
            return item;
        }
        ...
        {
            await this._db.ChatHubUser.AddAsync(ChatHubUser);
            await this._db.SaveChangesAsync(true);
        }
        ...
        public async Task Addsettings(ChatHubSettings ChatHubSetting)
        {
            await this._db.ChatHubSetting.AddAsync(ChatHubSetting);
            await this._db.SaveChangesAsync(true);
        }
        ...
        {
            await this._db.ChatHubCam.AddAsync(ChatHubCam);
            await this._db.SaveChangesAsync();
        }
